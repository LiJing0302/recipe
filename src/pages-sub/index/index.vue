...
const open = (id: string) => uni.navigateTo({ url: `/pages-sub/recipe/detail?id=${id}` })
...
const scan = () => uni.navigateTo({ url: '/pages-sub/scan/index' })
  ...
  <view class="home-page">
    <view class="home-top page-shell">
      ...
      <view class="quick-grid">
        ...
        <view class="quick-item" @click="switchAppTab(0)"><view class="quick-icon"><AppIcon name="calendar" size="md" /></view><view class="quick-copy"><text class="quick-title">安排菜单</text><text class="quick-desc">把想吃的放进今天</text></view><AppIcon name="arrow-up-right" size="sm" /></view>
      </view>
    </view>
